...
local redzlib = {
	Themes = {
		BlackBlue = {
			...
			["Color Stroke"] = Color3.fromRGB(0, 140, 255), -- أزرق (الدمج يكون عبر UIGradient)
		...
		BlackBlueSoft = {
			...
			["Color Stroke"] = Color3.fromRGB(120, 180, 255), -- أزرق فاتح
			["Color Theme"] = Color3.fromRGB(120, 180, 255),
